...
export const Sidebar = () => {
  ...
  if (priceData !== undefined) {
    ({
      basePrice, discountPercentage, discountedPrice, saleOngoing,
    } = priceData);
  }
  ...
  if (sidebarData !== undefined) {
    ({
      fullLifetimeAccess, accessTypes, assignments, certificateOfCompletion, downloadableResources,
    } = sidebarData);
  }
  ...
  const applyCoupon = !couponMenuOpen
    ? (
    ...
    : (
      <form onSubmit={(e) => e.preventDefault()}>
        <input className="sidebar-coupon-input" placeholder="Enter Coupon" type="text" />
    ...
    previewVideoElement = (
      <a href={previewVideoUrl}>
        <button className="sidebar-preview-video sidebar-cursor-pointer">
          <img src={previewVideoImgUrl} alt="Preview video image for this class." />
          <span className="sidebar-preview-video-overlay-gradient" />
          ...
          <div className="sidebar-course-includes">
            ...
            {totalArticles > 0
              ...
              <div className="sidebar-course-includes-item">
                <div className="sidebar-small-icon">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M 14 2 H 6 c -1.1 0 -1.99 0.9 -1.99 2 L 4 20 c 0 1.1 0.89 2 1.99 2 H 18 c 1.1 0 2 -0.9 2 -2 V 8 l -6 -6 Z M 6 20 V 4 h 7 v 5 h 5 v 11 H 6 Z" />
                  </svg>
                </div>
                <div className="sidebar-course-includes-text">
                  {totalArticles}
            ...
            {downloadableResources > 0
              ...
              <div className="sidebar-course-includes-item">
                <div className="sidebar-small-icon">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M 11.17 8 l -2 -2 H 4 v 12 h 16 V 8 h -8.83 Z M 4 4 h 6 l 2 2 h 8 c 1.1 0 2 0.9 2 2 v 10 c 0 1.1 -0.9 2 -2 2 H 4 c -1.1 0 -2 -0.9 -2 -2 l 0.01 -12 c 0 -1.1 0.89 -2 1.99 -2 Z m 6.55 9 v -3 h 2.9 v 3 H 16 l -4 4 l -4 -4 h 2.55 Z" />
                  </svg>
                </div>
                <div className="sidebar-course-includes-text">
            ...
            {totalExercises > 0
              ...
              <div className="sidebar-course-includes-item">
                <div className="sidebar-small-icon">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M 8 3 a 2 2 0 0 0 -2 2 v 4 a 2 2 0 0 1 -2 2 H 3 v 2 h 1 a 2 2 0 0 1 2 2 v 4 a 2 2 0 0 0 2 2 h 2 v -2 H 8 v -5 a 2 2 0 0 0 -2 -2 a 2 2 0 0 0 2 -2 V 5 h 2 V 3 H 8 Z m 8 0 a 2 2 0 0 1 2 2 v 4 a 2 2 0 0 0 2 2 h 1 v 2 h -1 a 2 2 0 0 0 -2 2 v 4 a 2 2 0 0 1 -2 2 h -2 v -2 h 2 v -5 a 2 2 0 0 1 2 -2 a 2 2 0 0 1 -2 -2 V 5 h -2 V 3 h 2 Z" />
                  </svg>
                </div>
                <div className="sidebar-course-includes-text">
                  {totalExercises}
            ...
            <div className="sidebar-course-includes-item">
              <div className="sidebar-small-icon">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M 18.6 6.62 c -1.44 0 -2.8 0.56 -3.77 1.53 L 12 10.66 L 10.48 12 h 0.01 L 7.8 14.39 c -0.64 0.64 -1.49 0.99 -2.4 0.99 c -1.87 0 -3.39 -1.51 -3.39 -3.38 S 3.53 8.62 5.4 8.62 c 0.91 0 1.76 0.35 2.44 1.03 l 1.13 1 l 1.51 -1.34 L 9.22 8.2 A 5.37 5.37 0 0 0 5.4 6.62 C 2.42 6.62 0 9.04 0 12 s 2.42 5.38 5.4 5.38 c 1.44 0 2.8 -0.56 3.77 -1.53 l 2.83 -2.5 l 0.01 0.01 L 13.52 12 h -0.01 l 2.69 -2.39 c 0.64 -0.64 1.49 -0.99 2.4 -0.99 c 1.87 0 3.39 1.51 3.39 3.38 s -1.52 3.38 -3.39 3.38 c -0.9 0 -1.76 -0.35 -2.44 -1.03 l -1.14 -1.01 l -1.51 1.34 l 1.27 1.12 a 5.386 5.386 0 0 0 3.82 1.57 c 2.98 0 5.4 -2.41 5.4 -5.38 s -2.42 -5.37 -5.4 -5.37 Z" />
                </svg>
              </div>
              <div className="sidebar-course-includes-text">
                {fullLifetimeAccess}
            ...
            <div className="sidebar-course-includes-item">
              <div className="sidebar-small-icon">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M 17 1.01 L 7 1 c -1.1 0 -2 0.9 -2 2 v 18 c 0 1.1 0.9 2 2 2 h 10 c 1.1 0 2 -0.9 2 -2 V 3 c 0 -1.1 -0.9 -1.99 -2 -1.99 Z M 17 19 H 7 V 5 h 10 v 14 Z" />
                </svg>
              </div>
              <div className="sidebar-course-includes-text">
                {accessTypes}
            ...
            {assignments
              ...
              <div className="sidebar-course-includes-item">
                <div className="sidebar-small-icon">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M 19 3 h -4.18 C 14.4 1.84 13.3 1 12 1 s -2.4 0.84 -2.82 2 H 5 c -1.1 0 -2 0.9 -2 2 v 14 c 0 1.1 0.9 2 2 2 h 14 c 1.1 0 2 -0.9 2 -2 V 5 c 0 -1.1 -0.9 -2 -2 -2 Z m -7 0 c 0.55 0 1 0.45 1 1 s -0.45 1 -1 1 s -1 -0.45 -1 -1 s 0.45 -1 1 -1 Z m 2 14 H 7 v -2 h 7 v 2 Z m 3 -4 H 7 v -2 h 10 v 2 Z m 0 -4 H 7 V 7 h 10 v 2 Z" />
                  </svg>
                </div>
                <div className="sidebar-course-includes-text">
                  Assignments
